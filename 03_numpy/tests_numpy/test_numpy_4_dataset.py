...
def test_data_1_student_averages():
    ...
    """
    student_avgs = student_scores.mean(axis=1)
...
def test_data_2_subject_max():
    ...
    """
    subject_max_scores = student_scores.max(axis=0)
...
def test_data_3_finding_low_scores():
    ...
    """
    low_english_math_scores = student_scores[student_scores[:, 1] < 80, 0]
...
def test_data_4_min_max_normalization():
    ...
    """
    normalized_scores = (student_scores - student_scores.min()) / (student_scores.max() - student_scores.min())
